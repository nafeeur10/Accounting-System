...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('contacts.update', [$user->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div>
                <input class="btn btn-danger btn-lg" type="submit" value="{{ trans('global.update') }}">
                <a class="btn btn-info btn-lg" href="{{ url()->previous() }}">
